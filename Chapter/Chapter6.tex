...
\begin{proposition}{6.10}
	For a vector space, finite dimension $\Leftrightarrow$ finite length $\Leftrightarrow$ a.c.c. $\Leftrightarrow$ d.c.c.. If the conditions are satisfied, length equals dimension.
\end{proposition}
